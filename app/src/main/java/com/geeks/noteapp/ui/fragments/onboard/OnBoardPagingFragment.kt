...
class OnBoardPagingFragment : Fragment() {
    ...
    private fun initialize() = with(binding) {
        when(requireArguments().getInt(ARG_ONBOARD_POSITION)){
            ...
            1 -> {
                lottieAnimationView.setAnimation(R.raw.animationnote)
                imgIndicator1.setImageResource(R.drawable.circle_gray)
                imgIndicator2.setImageResource(R.drawable.circle_orange)
            ...
            2 -> {
                imgIndicator1.setImageResource(R.drawable.circle_gray)
                imgIndicator2.setImageResource(R.drawable.circle_gray)
                imgIndicator3.setImageResource(R.drawable.circle_orange)
